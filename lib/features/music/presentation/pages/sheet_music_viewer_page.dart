        ...
        Row(
          ...
          children: [
            ...
            _PlaybackButton(
              ...
              onTap: widget.measures.isEmpty ? null : _playbackService.stopLoop,
            ),
          ],
        ),
...
class _PlaybackButton extends StatelessWidget {
  ...
  const _PlaybackButton({required this.icon, required this.onTap, this.primary = false});
  ...
  Widget build(BuildContext context) {
    return BeatterScaffold(
      appBar: AppBar(
        ...
        elevation: 0,
        title: Text(title, style: const TextStyle(color: AppTheme.textPrimary, fontSize: 18)),
